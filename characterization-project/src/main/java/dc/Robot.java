...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_VictorSPX leftMotor = setupWPI_VictorSPX(0, Sides.LEFT, false);
    ...
    WPI_VictorSPX rightMotor = setupWPI_VictorSPX(3, Sides.RIGHT, false);
    WPI_VictorSPX rightFollowerID4 = setupWPI_VictorSPX(4, Sides.FOLLOWER, false);    
    rightFollowerID4.follow(rightMotor);
    WPI_VictorSPX rightFollowerID5 = setupWPI_VictorSPX(5, Sides.FOLLOWER, false);    
