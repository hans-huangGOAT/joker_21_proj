...
public class AdjustVerDown extends CommandBase {
  private final Adjuster adjuster_subsys;

  /** Creates a new AdjustVerDown. */
  public AdjustVerDown(Adjuster adjuster_subsys) {
  ...
  public void initialize() {
    adjuster_subsys.set_adjuster_ver_down();
  }
